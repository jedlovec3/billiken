...
projected_players <- bind_rows(hitter_projections, pitcher_projections) %>% 
  ...
  select(Name, billikenTeam, contract, salary, Team, PA, AB, HR, R, RBI, SB, AVG, IP, W, SV, SO, ERA, WHIP, point_value, p_c, p_1b, p_2b, p_3b, p_ss, p_of, p_ci, p_mi, p_dh, p_util) %>% 
  arrange(desc(point_value)) #%>% 
  #filter(billikenTeam == "Melonheads") 
...
par <- projected_players %>% 
  ...
  arrange(desc(par)) %>% 
  select(Name, Team, billikenTeam, contract, salary, point_value, repl, par, PA, AB, HR, R, RBI, SB, AVG, IP, W, SV, SO, ERA, WHIP, p_c, p_1b, p_2b, p_3b, p_ss, p_of, p_ci, p_mi, p_dh, p_util)
