...
```{r}
bind_rows(hitter_projections_nl, pitcher_projections_nl) %>% 
...
par %>% 
  ...
  #filter(IP>0) %>% 
  #filter(billikenTeam == "Ben's Brilliant Team") %>% 
  filter(Name == "Nick Lodolo")
